...
public final class FacebookRequestError implements Parcelable {
    ...
    static final Range HTTP_RANGE_SUCCESS = new Range(200, TwitterApiErrorConstants.DEVICE_REGISTRATION_RATE_EXCEEDED);
    ...
    static synchronized FacebookRequestErrorClassification getErrorClassification() {
        ...
        appSettings = Utility.getAppSettingsWithoutQuery(FacebookSdk.getApplicationId());
        return appSettings == null ? FacebookRequestErrorClassification.getDefaultErrorClassification() : appSettings.getErrorClassification();
    }
