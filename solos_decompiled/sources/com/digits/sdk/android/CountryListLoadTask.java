...
class CountryListLoadTask extends AsyncTask<Void, Void, List<CountryInfo>> {
    ...
    public List<CountryInfo> doInBackground(Void... params) {
        List<CountryInfo> countryInfoList = new ArrayList<>(MAX_COUNTRIES);
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "BI").getDisplayCountry(), InputDeviceCompat.SOURCE_KEYBOARD));
        countryInfoList.add(new CountryInfo(new Locale("", "KH").getDisplayCountry(), 855));
        countryInfoList.add(new CountryInfo(new Locale("", "CM").getDisplayCountry(), TwitterApiErrorConstants.MISSING_LOGIN_VERIFICATION_REQUEST));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "TD").getDisplayCountry(), TwitterApiErrorConstants.EXPIRED_LOGIN_VERIFICATION_REQUEST));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "KM").getDisplayCountry(), TwitterApiErrorConstants.USER_IS_NOT_SDK_USER));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "ER").getDisplayCountry(), MAX_COUNTRIES));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "GL").getDisplayCountry(), TwitterApiErrorConstants.DEVICE_REGISTRATION_RATE_EXCEEDED));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "MW").getDisplayCountry(), AppService.TARGET_TTS));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "YT").getDisplayCountry(), AppService.UPDATE_TTS));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "NA").getDisplayCountry(), AppService.NOTIFICATION_TTS));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "RE").getDisplayCountry(), AppService.UPDATE_TTS));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "RW").getDisplayCountry(), ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "ST").getDisplayCountry(), TwitterApiConstants.Errors.GUEST_AUTH_ERROR_CODE));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "ZW").getDisplayCountry(), AppService.MULTI_TTS));
    ...
    public void onPostExecute(List<CountryInfo> result) {
        if (this.listener != null) {
            this.listener.onLoadComplete(result);
        }
    }
}
