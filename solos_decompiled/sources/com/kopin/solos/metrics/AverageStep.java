...
public class AverageStep extends GhostPage<Long> {
    public AverageStep(AppService appService) {
        super(appService, TemplateManager.DataType.TIME);
        addPage(MetricType.GHOST_AVERAGE_STEP);
        addPage(MetricType.AVERAGE_TARGET_STEP);
        setUnit(appService.getString(R.string.run_cadence_unit_vert));
    ...
    protected void prepare() {
        super.prepare();
        setUnit(this.mAppService.getString(LiveRide.isGhostWorkout() ? R.string.run_cadence_unit_vert : R.string.run_cadence_unit_caps));
    }
