...
public class BaseDataTypes {
    ...
    public static final DataUnits UNITS_METERS = new DataUnitsImpl("meters", Prefs.MODE_MANUAL);
    ...
    public static final DataUnits UNITS_NEWTON = new DataUnitsImpl("newton", VCardConstants.PROPERTY_N);
    public static final DataUnits UNITS_NEWTON_METERS = new DataUnitsImpl("newton_meters", "N*m");
    public static final DataUnits UNITS_SECONDS = new DataUnitsImpl("seconds", Prefs.UNIT_SPEED);
    ...
    public static final DataField FIELD_ENERGY_EXPENDED = new DataFieldImpl(ID_ENERGY_EXPENDED, DATA_TYPE_FLOAT, UNITS_JOULES);
    ...
    public static final DataField FIELD_HEIGHT = new DataFieldImpl("height", DATA_TYPE_FLOAT, UNITS_METERS);
    ...
    public static final DataField FIELD_WILLPOWER = new DataFieldImpl(ID_WILLPOWER, DATA_TYPE_FLOAT, null);
    public static final String ID_DISTANCE = "distance";
    public static final DataField FIELD_DISTANCE = new DataFieldImpl(ID_DISTANCE, DATA_TYPE_FLOAT, UNITS_METERS);
    ...
    public static final DataField FIELD_STEPS = new DataFieldImpl(ID_STEPS, DATA_TYPE_INT, null);
    public static final String ID_HEART_BEAT = "heart_beat";
    public static final DataField FIELD_HEART_BEAT = new DataFieldImpl(ID_HEART_BEAT, DATA_TYPE_INT, null);
    ...
    public static final DataField FIELD_WHEEL_REVOLUTIONS = new DataFieldImpl(ID_WHEEL_REVOLUTIONS, DATA_TYPE_INT, null);
    public static final String ID_CRANK_REVOLUTIONS = "crank_revolutions";
    public static final DataField FIELD_CRANK_REVOLUTIONS = new DataFieldImpl(ID_CRANK_REVOLUTIONS, DATA_TYPE_INT, null);
    ...
    public static final DataField FIELD_POSTURE = new DataFieldImpl(ID_POSTURE, DATA_TYPE_FLOAT, null);
    ...
    public static final DataField FIELD_MASS_PERCENT_CHANGE = new DataFieldImpl("mass_percent_change", DATA_TYPE_FLOAT, null);
    ...
    public static final DataField FIELD_STEPS_SUM = new DataFieldImpl("steps_sum", DATA_TYPE_INT, null);
    public static final DataField FIELD_SESSIONS_SUM = new DataFieldImpl("sessions_sum", DATA_TYPE_INT, null);
    ...
    public static final DataType TYPE_ELEVATION = new DataTypeImpl(ID_ELEVATION, DataPeriod.INSTANT, "The user's elevation", Arrays.asList(FIELD_ELEVATION, FIELD_VERTICAL_ACCURACY));
    public static final DataType TYPE_HEART_RATE = new DataTypeImpl(ID_HEART_RATE, DataPeriod.INSTANT, "The user's heart rate", Arrays.asList(FIELD_HEART_RATE));
    ...
    public static final DataType TYPE_BODY_MASS = new DataTypeImpl(ID_BODY_MASS, DataPeriod.INSTANT, "The user's body mass", Arrays.asList(FIELD_BODY_MASS));
    public static final DataType TYPE_SPEED = new DataTypeImpl(ID_SPEED, DataPeriod.INSTANT, "The user's speed", Arrays.asList(FIELD_SPEED));
    public static final DataType TYPE_WILLPOWER = new DataTypeImpl(ID_WILLPOWER, DataPeriod.INTERVAL, "The user's WILLpower™", Arrays.asList(FIELD_WILLPOWER));
    public static final DataType TYPE_DISTANCE = new DataTypeImpl(ID_DISTANCE, DataPeriod.INTERVAL, "The distance traveled by the user over a period of time", Arrays.asList(FIELD_DISTANCE));
    public static final DataType TYPE_ENERGY_EXPENDED = new DataTypeImpl(ID_ENERGY_EXPENDED, DataPeriod.INTERVAL, "The energy that a user has expended over a period of time", Arrays.asList(FIELD_ENERGY_EXPENDED));
    public static final DataType TYPE_ENERGY_CONSUMED = new DataTypeImpl(ID_ENERGY_CONSUMED, DataPeriod.INTERVAL, "The energy that a user has consumed over a period of time", Arrays.asList(FIELD_ENERGY_CONSUMED));
    public static final DataType TYPE_STEPS = new DataTypeImpl(ID_STEPS, DataPeriod.INTERVAL, "The number of steps taken by the user over a period of time", Arrays.asList(FIELD_STEPS));
    public static final DataType TYPE_HEART_BEAT = new DataTypeImpl(ID_HEART_BEAT, DataPeriod.INSTANT, "The single heart beat of a user", Arrays.asList(FIELD_HEART_BEAT));
    public static final DataType TYPE_CYCLING_CADENCE = new DataTypeImpl(ID_CYCLING_CADENCE, DataPeriod.INSTANT, "The user's cycling cadence", Arrays.asList(FIELD_CYCLING_CADENCE));
    public static final DataType TYPE_STRIDE_LENGTH = new DataTypeImpl(ID_STRIDE_LENGTH, DataPeriod.INSTANT, "The user's stride length", Arrays.asList(FIELD_STRIDE_LENGTH));
    public static final DataType TYPE_AIR_TEMPERATURE = new DataTypeImpl(ID_AIR_TEMPERATURE, DataPeriod.INSTANT, "The current air temperature", Arrays.asList(FIELD_AIR_TEMPERATURE));
    public static final DataType TYPE_RUN_CADENCE = new DataTypeImpl(ID_RUN_CADENCE, DataPeriod.INSTANT, "The user's run cadence", Arrays.asList(FIELD_RUN_CADENCE));
    public static final DataType TYPE_CYCLING_POWER = new DataTypeImpl(ID_CYCLING_POWER, DataPeriod.INSTANT, "The user's cycling power", Arrays.asList(FIELD_CYCLING_POWER));
    public static final DataType TYPE_CYCLING_POWER_BALANCE = new DataTypeImpl(ID_CYCLING_POWER_BALANCE, DataPeriod.INSTANT, "The user's cycling power balance", Arrays.asList(FIELD_CYCLING_POWER_BALANCE));
    public static final DataType TYPE_ACCUMULATED_TORQUE = new DataTypeImpl(ID_ACCUMULATED_TORQUE, DataPeriod.INTERVAL, "The user's accumulated torque over a period of time", Arrays.asList(FIELD_ACCUMULATED_TORQUE));
    public static final DataType TYPE_WHEEL_REVOLUTIONS = new DataTypeImpl(ID_WHEEL_REVOLUTIONS, DataPeriod.INTERVAL, "The user's count of wheel revolutions over a period of time", Arrays.asList(FIELD_WHEEL_REVOLUTIONS));
    public static final DataType TYPE_CRANK_REVOLUTIONS = new DataTypeImpl(ID_CRANK_REVOLUTIONS, DataPeriod.INTERVAL, "The user's count of crank revolutions over a period of time", Arrays.asList(FIELD_CRANK_REVOLUTIONS));
    public static final String ID_EXTREME_FORCES = "extreme_forces";
    public static final DataType TYPE_EXTREME_FORCES = new DataTypeImpl(ID_EXTREME_FORCES, DataPeriod.INTERVAL, "The user's minimum and maximum force over a period of time", Arrays.asList(FIELD_MAX_FORCE, FIELD_MIN_FORCE));
    public static final String ID_EXTREME_TORQUE = "extreme_torque";
    public static final DataType TYPE_EXTREME_TORQUE = new DataTypeImpl(ID_EXTREME_TORQUE, DataPeriod.INTERVAL, "The user's minimum and maximum torque over a period of time", Arrays.asList(FIELD_MAX_TORQUE, FIELD_MIN_TORQUE));
    public static final String ID_EXTREME_ANGLES = "extreme_angles";
    public static final DataType TYPE_EXTREME_ANGLES = new DataTypeImpl(ID_EXTREME_ANGLES, DataPeriod.INTERVAL, "The user's minimum and maximum angle over a period of time", Arrays.asList(FIELD_MAX_ANGLE, FIELD_MIN_ANGLE));
    public static final DataType TYPE_TOP_DEAD_SPOT_ANGLE = new DataTypeImpl(ID_TOP_DEAD_SPOT_ANGLE, DataPeriod.INSTANT, "The angle of the top dead spot of a pedal stroke", Arrays.asList(FIELD_TOP_DEAD_SPOT_ANGLE));
    public static final DataType TYPE_BOTTOM_DEAD_SPOT_ANGLE = new DataTypeImpl(ID_BOTTOM_DEAD_SPOT_ANGLE, DataPeriod.INSTANT, "The angle of the bottom dead spot of a pedal stroke", Arrays.asList(FIELD_BOTTOM_DEAD_SPOT_ANGLE));
    public static final DataType TYPE_POSTURE = new DataTypeImpl(ID_POSTURE, DataPeriod.INSTANT, "The user's current posture", Arrays.asList(FIELD_POSTURE));
    public static final DataType TYPE_BEARING = new DataTypeImpl(ID_BEARING, DataPeriod.INSTANT, "The user's bearing", Arrays.asList(FIELD_BEARING));
    public static final DataType TYPE_INTENSITY = new DataTypeImpl(ID_INTENSITY, DataPeriod.INSTANT, "The user's current intensity", Arrays.asList(FIELD_INTENSITY));
    public static final String ID_ELEVATION_SUMMARY = "elevation_summary";
    public static final DataType TYPE_ELEVATION_SUMMARY = new DataTypeImpl(ID_ELEVATION_SUMMARY, DataPeriod.INTERVAL, "The user's elevation summary", Arrays.asList(FIELD_ELEVATION_MAX, FIELD_ELEVATION_MIN, FIELD_ELEVATION_AVG, FIELD_ELEVATION_GAIN));
    public static final String ID_HEART_RATE_SUMMARY = "heart_rate_summary";
    public static final DataType TYPE_HEART_RATE_SUMMARY = new DataTypeImpl(ID_HEART_RATE_SUMMARY, DataPeriod.INTERVAL, "The user's heart rate summary", Arrays.asList(FIELD_HEART_RATE_MAX, FIELD_HEART_RATE_MIN, FIELD_HEART_RATE_AVG));
    public static final String ID_SPEED_SUMMARY = "speed_summary";
    public static final DataType TYPE_SPEED_SUMMARY = new DataTypeImpl(ID_SPEED_SUMMARY, DataPeriod.INTERVAL, "The user's speed summary", Arrays.asList(FIELD_SPEED_MAX, FIELD_SPEED_MIN, FIELD_SPEED_AVG));
    public static final String ID_RUN_CADENCE_SUMMARY = "run_cadence_summary";
    public static final DataType TYPE_RUN_CADENCE_SUMMARY = new DataTypeImpl(ID_RUN_CADENCE_SUMMARY, DataPeriod.INTERVAL, "The user's run cadence summary", Arrays.asList(FIELD_RUN_CADENCE_MAX, FIELD_RUN_CADENCE_MIN, FIELD_RUN_CADENCE_AVG));
    public static final String ID_CYCLING_POWER_SUMMARY = "cycling_power_summary";
    public static final DataType TYPE_CYCLING_POWER_SUMMARY = new DataTypeImpl(ID_CYCLING_POWER_SUMMARY, DataPeriod.INTERVAL, "The user's cycling power summary", Arrays.asList(FIELD_CYCLING_POWER_MAX, FIELD_CYCLING_POWER_MIN, FIELD_CYCLING_POWER_AVG));
    public static final String ID_DISTANCE_SUMMARY = "distance_summary";
    public static final DataType TYPE_DISTANCE_SUMMARY = new DataTypeImpl(ID_DISTANCE_SUMMARY, DataPeriod.INTERVAL, "A summary of the distance a user has traveled over a period of time", Arrays.asList(FIELD_DISTANCE_SUM));
    public static final String ID_ACTIVE_TIME_SUMMARY = "active_time_summary";
    public static final DataType TYPE_ACTIVE_TIME_SUMMARY = new DataTypeImpl(ID_ACTIVE_TIME_SUMMARY, DataPeriod.INTERVAL, "A summary of a user's active time over a period of time", Arrays.asList(FIELD_ACTIVITY_TIME_SUM));
    public static final String ID_ENERGY_EXPENDED_SUMMARY = "energy_expended_summary";
    public static final DataType TYPE_ENERGY_EXPENDED_SUMMARY = new DataTypeImpl(ID_ENERGY_EXPENDED_SUMMARY, DataPeriod.INTERVAL, "A summary of a user's energy expended over a period of time", Arrays.asList(FIELD_ENERGY_EXPENDED_SUM));
    public static final String ID_ENERGY_CONSUMED_SUMMARY = "energy_consumed_summary";
    public static final DataType TYPE_ENERGY_CONSUMED_SUMMARY = new DataTypeImpl(ID_ENERGY_CONSUMED_SUMMARY, DataPeriod.INTERVAL, "A summary of a user's energy consumed over a period of time", Arrays.asList(FIELD_ENERGY_CONSUMED_SUM));
    ...
    public static final DataType TYPE_STEPS_SUMMARY = new DataTypeImpl(ID_STEPS_SUMMARY, DataPeriod.INTERVAL, "A summary of the user's steps over a period of time", Arrays.asList(FIELD_STEPS_SUM));
    public static final String ID_SESSIONS_SUMMARY = "sessions_summary";
    public static final DataType TYPE_SESSIONS_SUMMARY = new DataTypeImpl(ID_SESSIONS_SUMMARY, DataPeriod.INTERVAL, "A summary of a user's workout sessions over a period of time", Arrays.asList(FIELD_SESSIONS_SUM, FIELD_SESSIONS_DURATION_SUM, FIELD_SESSIONS_DISTANCE_SUM));
    public static final String ID_SLEEP_SUMMARY = "sleep_summary";
    public static final DataType TYPE_SLEEP_SUMMARY = new DataTypeImpl(ID_SLEEP_SUMMARY, DataPeriod.INTERVAL, "A summary of a user's sleep over a period of time", Arrays.asList(FIELD_SLEEP_TIME_SUM, FIELD_SLEEP_TIME_AVG));
    ...
    public static final Map<String, DataType> ALL_BASE_TYPE_MAP = new HashMap<String, DataType>() { // from class: com.ua.sdk.datapoint.BaseDataTypes.1
        {
            DataType[] arr$ = BaseDataTypes.ALL_BASE_TYPE;
