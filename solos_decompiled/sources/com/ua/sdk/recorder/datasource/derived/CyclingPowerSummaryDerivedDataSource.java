...
public class CyclingPowerSummaryDerivedDataSource extends DerivedDataSource {
    ...
    protected CyclingPowerSummaryDerivedDataSource(DataSourceIdentifier dataSourceIdentifier, List<DataTypeRef> dataTypeRefs) {
    ...
    public void deriveDataPoint(RecorderCalculator recorderCalculator, DataSourceIdentifier triggerDataSourceIdentifier, DataTypeRef triggerDataTypeRef, DataPoint triggerDataPoint) {
        if (this.dataTypeRefTriggers.contains(triggerDataTypeRef) && this.recordData) {
            ...
            DataField max = BaseDataTypes.FIELD_CYCLING_POWER_MAX;
            DataField min = BaseDataTypes.FIELD_CYCLING_POWER_MIN;
            DataField avg = BaseDataTypes.FIELD_CYCLING_POWER_AVG;
            Double current = triggerDataPoint.getValueDouble(BaseDataTypes.FIELD_CYCLING_POWER);
