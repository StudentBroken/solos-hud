...
public class GroupInviteListJsonParser extends AbstractGsonParser<GroupInviteList> {
    ...
    public GroupInviteList read(Gson gson, JsonReader reader) throws UaException {
        Type type = new TypeToken<GroupInviteList>() { // from class: com.ua.sdk.group.invite.GroupInviteListJsonParser.1
        }.getType();
        return (GroupInviteList) gson.fromJson(reader, type);
    }
}
