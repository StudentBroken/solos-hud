...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        public static final FieldType GROUP = new FieldType("GROUP", 9, JavaType.MESSAGE, 3) { // from class: com.google.tagmanager.protobuf.WireFormat.FieldType.2
            @Override // com.google.tagmanager.protobuf.WireFormat.FieldType
        ...
        static {
            int i = 2;
            STRING = new FieldType("STRING", 8, JavaType.STRING, i) { // from class: com.google.tagmanager.protobuf.WireFormat.FieldType.1
                @Override // com.google.tagmanager.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            };
            MESSAGE = new FieldType("MESSAGE", 10, JavaType.MESSAGE, i) { // from class: com.google.tagmanager.protobuf.WireFormat.FieldType.3
                @Override // com.google.tagmanager.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            };
            BYTES = new FieldType("BYTES", 11, JavaType.BYTE_STRING, i) { // from class: com.google.tagmanager.protobuf.WireFormat.FieldType.4
                @Override // com.google.tagmanager.protobuf.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
