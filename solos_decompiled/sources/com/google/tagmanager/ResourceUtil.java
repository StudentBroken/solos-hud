...
class ResourceUtil {
        ...
        switch (value.getType()) {
            ...
            case MACRO_REFERENCE:
                ...
                if (!servingValue2.hasMacroNameReference()) {
                    ...
                    TypeSystem.Value macroNameValue = expandValue(servingValue2.getMacroNameReference(), resource, expandedValues, pendingExpansions);
    ...
    private static ExpandedFunctionCall expandFunctionCall(Serving.FunctionCall functionCall, Serving.Resource resource, TypeSystem.Value[] expandedValues, int idx) throws InvalidResourceException {
        ...
        for (Integer i : functionCall.getPropertyList()) {
            ...
            String key = (String) getWithBoundsCheck(resource.getKeyList(), p.getKey(), "keys");
            TypeSystem.Value value = (TypeSystem.Value) getWithBoundsCheck(expandedValues, p.getValue(), "values");
