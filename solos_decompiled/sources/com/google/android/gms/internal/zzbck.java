...
public abstract class zzbck<R extends Result, A extends Api.zzb> extends zzbcq<R> implements zzbcl<R> {
    ...
    @Deprecated
    protected zzbck(Api.zzc<A> zzcVar, GoogleApiClient googleApiClient) {
        super((GoogleApiClient) zzbr.zzb(googleApiClient, "GoogleApiClient must not be null"));
        this.zzaBO = (Api.zzc) zzbr.zzu(zzcVar);
        this.zzayY = null;
    }

    protected zzbck(Api<?> api, GoogleApiClient googleApiClient) {
        super((GoogleApiClient) zzbr.zzb(googleApiClient, "GoogleApiClient must not be null"));
        this.zzaBO = (Api.zzc<A>) api.zzpb();
        this.zzayY = api;
    }
