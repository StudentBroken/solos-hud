...
public final class zzchb extends zzciv {
    public zzchb(zzchx zzchxVar) {
        super(zzchxVar);
    }
    ...
    @WorkerThread
    public final void zza(String str, URL url, Map<String, String> map, zzchd zzchdVar) {
        super.zzjB();
        zzkC();
        zzbr.zzu(url);
        zzbr.zzu(zzchdVar);
        super.zzwD().zzk(new zzchf(this, str, url, null, map, zzchdVar));
    }

    @WorkerThread
    public final void zza(String str, URL url, byte[] bArr, Map<String, String> map, zzchd zzchdVar) {
        super.zzjB();
        zzkC();
        zzbr.zzu(url);
        zzbr.zzu(bArr);
        zzbr.zzu(zzchdVar);
        super.zzwD().zzk(new zzchf(this, str, url, bArr, null, zzchdVar));
    }
