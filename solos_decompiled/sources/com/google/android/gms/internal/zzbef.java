...
final class zzbef implements ResultCallback<Status> {
    ...
    zzbef(zzbeb zzbebVar, zzbfz zzbfzVar, boolean z, GoogleApiClient googleApiClient) {
        this.zzaDP = zzbebVar;
        this.zzaDR = zzbfzVar;
        this.zzaDS = z;
    ...
    public final /* synthetic */ void onResult(@NonNull Result result) {
        ...
        com.google.android.gms.auth.api.signin.internal.zzy.zzaj(this.zzaDP.mContext).zzmN();
