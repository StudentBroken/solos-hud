...
public class DataMap {
    ...
    private final HashMap<String, Object> zzrR = new HashMap<>();
    ...
    public static DataMap fromByteArray(byte[] bArr) {
        try {
            return io.zza(new ip(iq.zzz(bArr), new ArrayList()));
        } catch (aie e) {
    ...
    public boolean containsKey(String str) {
        return this.zzrR.containsKey(str);
    }
    ...
    public <T> T get(String str) {
        return (T) this.zzrR.get(str);
    }

    public Asset getAsset(String str) {
        Object obj = this.zzrR.get(str);
        if (obj == null) {
            return null;
        }
        try {
    ...
    public int hashCode() {
        return this.zzrR.hashCode() * 29;
    }

    public boolean isEmpty() {
        return this.zzrR.isEmpty();
    }

    public Set<String> keySet() {
        return this.zzrR.keySet();
    }

    public void putAll(DataMap dataMap) {
        for (String str : dataMap.keySet()) {
            this.zzrR.put(str, dataMap.get(str));
        }
    }

    public void putAsset(String str, Asset asset) {
        this.zzrR.put(str, asset);
    }

    public void putBoolean(String str, boolean z) {
        this.zzrR.put(str, Boolean.valueOf(z));
    }

    public void putByte(String str, byte b) {
        this.zzrR.put(str, Byte.valueOf(b));
    }

    public void putByteArray(String str, byte[] bArr) {
        this.zzrR.put(str, bArr);
    }

    public void putDataMap(String str, DataMap dataMap) {
        this.zzrR.put(str, dataMap);
    }

    public void putDataMapArrayList(String str, ArrayList<DataMap> arrayList) {
        this.zzrR.put(str, arrayList);
    }

    public void putDouble(String str, double d) {
        this.zzrR.put(str, Double.valueOf(d));
    }

    public void putFloat(String str, float f) {
        this.zzrR.put(str, Float.valueOf(f));
    }

    public void putFloatArray(String str, float[] fArr) {
        this.zzrR.put(str, fArr);
    }
    ...
    public void putLong(String str, long j) {
        this.zzrR.put(str, Long.valueOf(j));
    }

    public void putLongArray(String str, long[] jArr) {
        this.zzrR.put(str, jArr);
    }
    ...
    public Object remove(String str) {
        return this.zzrR.remove(str);
    }

    public int size() {
        return this.zzrR.size();
    }

    public Bundle toBundle() {
        Bundle bundle = new Bundle();
        for (String str : this.zzrR.keySet()) {
            zzb(bundle, str, this.zzrR.get(str));
        }
        return bundle;
    }

    public byte[] toByteArray() {
        return aif.zzd(io.zza(this).zzbTH);
    }

    public String toString() {
        return this.zzrR.toString();
    }
}
