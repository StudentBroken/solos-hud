...
public class zzgh {
    ...
    private static boolean zzc(PackageInfo packageInfo, boolean z) {
        ...
        return z ? zza(packageInfo, zzbTF, zzbTG) : zza(packageInfo, zzbTF);
    }
    ...
    private final PackageInfo zzgp(String str) {
        try {
            return zzbim.zzaP(this.mContext).getPackageInfo(str, 64);
        } catch (PackageManager.NameNotFoundException e) {
            return null;
        }
    }

    public final boolean zzgo(String str) {
        PackageInfo packageInfoZzgp = zzgp(str);
        if (packageInfoZzgp == null) {
            return false;
        }
        if (com.google.android.gms.common.zzo.zzaw(this.mContext)) {
            return zzc(packageInfoZzgp, true);
        }
        boolean zZzc = zzc(packageInfoZzgp, false);
        if (zZzc || !zzc(packageInfoZzgp, true)) {
            return zZzc;
        }
