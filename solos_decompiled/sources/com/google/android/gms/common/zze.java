...
public class zze {
    ...
    public static Intent zza(Context context, int i, @Nullable String str) {
        switch (i) {
            case 1:
            case 2:
                return (context == null || !com.google.android.gms.common.util.zzk.zzaH(context)) ? zzaj.zzw("com.google.android.gms", zzx(context, str)) : zzaj.zzrC();
            case 3:
    ...
    public final PendingIntent zza(Context context, int i, int i2, @Nullable String str) {
        ...
        return PendingIntent.getActivity(context, i2, intentZza, VCardConfig.FLAG_REFRAIN_QP_TO_NAME_PROPERTIES);
    }
