...
public final class GooglePlayServicesUtil extends zzo {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog dialogZza = GoogleApiAvailability.zza(activity, i, zzt.zza(fragment, zze.zza(activity, i, Prefs.MODE_DISTANCE), i2), onCancelListener);
        if (dialogZza == null) {
            return false;
        }
        GoogleApiAvailability.zza(activity, dialogZza, GMS_ERROR_DIALOG, onCancelListener);
        return true;
    }
