...
public class CommonUtils {
    ...
    */
    ...
    public static ActivityManager.RunningAppProcessInfo getAppProcessInfo(String packageName, Context context) {
        ActivityManager actman = (ActivityManager) context.getSystemService(Ride.ACTIVITY);
    ...
    public static String createInstanceIdFrom(String... sliceIds) {
        ...
        Iterator<String> it = sliceIdList.iterator();
        while (it.hasNext()) {
            sb.append(it.next());
        }
    ...
    public static long calculateFreeRamInBytes(Context context) {
        ...
        ((ActivityManager) context.getSystemService(Ride.ACTIVITY)).getMemoryInfo(mi);
        return mi.availMem;
    }
    ...
    public static float getBatteryLevel(Context context) {
        ...
        int level = battery.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1);
