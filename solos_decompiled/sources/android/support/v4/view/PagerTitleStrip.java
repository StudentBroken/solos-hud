...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void setNonPrimaryAlpha(@FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float alpha) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int measuredHeight = View.resolveSizeAndState(height, heightMeasureSpec, childState << 16);
