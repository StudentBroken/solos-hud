...
public final class PointerIconCompat {
    ...
    public static PointerIconCompat create(Bitmap bitmap, float hotSpotX, float hotSpotY) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(PointerIcon.create(bitmap, hotSpotX, hotSpotY)) : new PointerIconCompat(null);
    }

    public static PointerIconCompat load(Resources resources, int resourceId) {
        return Build.VERSION.SDK_INT >= 24 ? new PointerIconCompat(PointerIcon.load(resources, resourceId)) : new PointerIconCompat(null);
    }
}
