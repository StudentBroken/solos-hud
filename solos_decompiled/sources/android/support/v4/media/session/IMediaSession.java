    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    IMediaControllerCallback _arg010 = IMediaControllerCallback.Stub.asInterface(data.readStrongBinder());
                    registerCallbackListener(_arg010);
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    IMediaControllerCallback _arg011 = IMediaControllerCallback.Stub.asInterface(data.readStrongBinder());
                    unregisterCallbackListener(_arg011);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 11:
                    ...
                    adjustVolume(_arg012, _arg110, _arg22);
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setVolumeTo(_arg013, _arg111, _arg23);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    ...
                    playFromMediaId(_arg014, _arg15);
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 26:
                    ...
                    sendCustomAction(_arg018, _arg1);
                    reply.writeNoException();
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    ...
                    prepareFromMediaId(_arg019, _arg18);
                    reply.writeNoException();
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    prepareFromSearch(_arg020, _arg17);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 39:
                    ...
                    setRepeatMode(_arg021);
                    reply.writeNoException();
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg022 = data.readInt() != 0;
                    setShuffleModeEnabledDeprecated(_arg022);
                    reply.writeNoException();
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
