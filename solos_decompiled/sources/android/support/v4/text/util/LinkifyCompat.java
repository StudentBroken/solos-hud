...
public final class LinkifyCompat {
    ...
    public static final boolean addLinks(@NonNull Spannable text, @NonNull Pattern pattern, @Nullable String scheme) {
        return Build.VERSION.SDK_INT >= 26 ? Linkify.addLinks(text, pattern, scheme) : addLinks(text, pattern, scheme, (String[]) null, (Linkify.MatchFilter) null, (Linkify.TransformFilter) null);
    }
    ...
    public static final boolean addLinks(@NonNull Spannable spannable, @NonNull Pattern pattern, @Nullable String scheme, @Nullable Linkify.MatchFilter matchFilter, @Nullable Linkify.TransformFilter transformFilter) {
        return Build.VERSION.SDK_INT >= 26 ? Linkify.addLinks(spannable, pattern, scheme, matchFilter, transformFilter) : addLinks(spannable, pattern, scheme, (String[]) null, matchFilter, transformFilter);
    }
