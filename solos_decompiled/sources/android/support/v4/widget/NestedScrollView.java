                ...
                if (activePointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (dispatchNestedScroll(0, scrolledDeltaY, 0, unconsumedY, this.mScrollOffset, 0)) {
                            ...
                            if (pulledToY < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, deltaY / getHeight(), ev.getX(activePointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (pulledToY > range) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowBottom, deltaY / getHeight(), 1.0f - (ev.getX(activePointerIndex) / getWidth()));
    ...
    public void computeScroll() {
        if (this.mScroller.computeScrollOffset()) {
            ...
            if (dy != 0) {
                ...
                if (!dispatchNestedScroll(0, scrolledDeltaY, 0, unconsumedY, null, 1)) {
