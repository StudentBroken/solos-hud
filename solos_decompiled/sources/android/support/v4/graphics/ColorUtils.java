...
public final class ColorUtils {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_X) double x, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double y, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Z) double z, @NonNull double[] outLab) {
        if (outLab.length != 3) {
    ...
    public static void LABToXYZ(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double l, @FloatRange(from = -128.0d, to = 127.0d) double a, @FloatRange(from = -128.0d, to = 127.0d) double b, @NonNull double[] outXyz) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_X) double x, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double y, @FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Z) double z) {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, to = XYZ_WHITE_REFERENCE_Y) double l, @FloatRange(from = -128.0d, to = 127.0d) double a, @FloatRange(from = -128.0d, to = 127.0d) double b) {
        double[] result = getTempDouble3Array();
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int color1, @ColorInt int color2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float ratio) {
    ...
    public static void blendHSL(@NonNull float[] hsl1, @NonNull float[] hsl2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float ratio, @NonNull float[] outResult) {
    ...
    public static void blendLAB(@NonNull double[] lab1, @NonNull double[] lab2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) double ratio, @NonNull double[] outResult) {
        if (outResult.length != 3) {
