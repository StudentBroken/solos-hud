...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            int descendantFocusability = a2.getInt(android.support.v7.recyclerview.R.styleable.RecyclerView_android_descendantFocusability, -1);
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return !className.contains(".") ? RecyclerView.class.getPackage().getName() + ClassUtils.PACKAGE_SEPARATOR_CHAR + className : className;
    }
    ...
    */
    ...
    class ViewFlinger implements Runnable {
        ...
        public void smoothScrollBy(int dx, int dy, Interpolator interpolator) {
            int iComputeScrollDuration = computeScrollDuration(dx, dy, 0, 0);
            if (interpolator == null) {
                interpolator = RecyclerView.sQuinticInterpolator;
            }
            smoothScrollBy(dx, dy, iComputeScrollDuration, interpolator);
        }
    ...
    public static class RecycledViewPool {
        ...
        public void putRecycledView(ViewHolder scrap) {
            ...
            ArrayList<ViewHolder> arrayList = getScrapDataForType(viewType).mScrapHeap;
