        ...
        public View getFocusableViewAfter(int referenceChildPosition, int layoutDir) {
            ...
            if (layoutDir == -1) {
                ...
                for (int i = 0; i < limit; i++) {
                    ...
                    if ((StaggeredGridLayoutManager.this.getPosition(view) > referenceChildPosition) != StaggeredGridLayoutManager.this.mReverseLayout) {
                        break;
                    }
                    candidate = view;
                }
                ...
                for (int i2 = this.mViews.size() - 1; i2 >= 0; i2--) {
                    ...
                    if ((StaggeredGridLayoutManager.this.getPosition(view2) > referenceChildPosition) != (!StaggeredGridLayoutManager.this.mReverseLayout)) {
                        break;
                    }
                    candidate = view2;
                }
