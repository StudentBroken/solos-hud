...
public class AcceptDenyDialogPreference extends Preference implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AcceptDenyDialogPreference, defStyleAttr, defStyleRes);
        this.mDialogTitle = a.getString(R.styleable.AcceptDenyDialogPreference_dialogTitle);
        if (this.mDialogTitle == null) {
            this.mDialogTitle = getTitle();
        }
        this.mDialogMessage = a.getString(R.styleable.AcceptDenyDialogPreference_dialogMessage);
        this.mDialogIcon = a.getDrawable(R.styleable.AcceptDenyDialogPreference_dialogIcon);
        this.mShowPositiveButton = a.getBoolean(R.styleable.AcceptDenyDialogPreference_showPositiveDialogButton, true);
        this.mShowNegativeButton = a.getBoolean(R.styleable.AcceptDenyDialogPreference_showNegativeDialogButton, true);
        a.recycle();
    }
    ...
    public void onDismiss(@NonNull DialogInterface dialog) {
        ...
        if (this.mOnDialogClosedListener != null) {
            this.mOnDialogClosedListener.onDialogClosed(this.mWhichButtonClicked == -1);
        }
    }
