...
public interface IAuthenticationRequestCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAuthenticationRequestCallback {
        ...
        public static IAuthenticationRequestCallback asInterface(IBinder obj) {
            ...
            if (iin != null && (iin instanceof IAuthenticationRequestCallback)) {
        ...
        private static class Proxy implements IAuthenticationRequestCallback {
